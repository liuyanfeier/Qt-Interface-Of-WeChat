...
QT_MOC_LITERAL(3, 16, 15), // "onDetailClicked"
QT_MOC_LITERAL(4, 32, 11) // "str_context"

    },
    "GLabel\0clicked\0\0onDetailClicked\0"
    "str_context"
};
...
void GLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onDetailClicked(); break;
        default: ;
        }
        ...
        {
            typedef void (GLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLabel::clicked)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->getStrContext(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setContext(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
